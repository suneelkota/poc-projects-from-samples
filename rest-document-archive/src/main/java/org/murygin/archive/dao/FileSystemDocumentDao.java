    ...
    public void insert(Document document) {
        try {
           // createDirectory(document);
        	AmazonS3Dao amazonS3Dao = new AmazonS3Dao();
        	amazonS3Dao.createFolder(document);
...
/*    @Override
    ...
    {
    	AmazonS3InquiryDao amazonS3InquiryDao= new AmazonS3InquiryDao();
    	return amazonS3InquiryDao.getFilesList();
    }
